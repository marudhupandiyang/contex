(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["contex"] = factory(require("react"));
	else
		root["contex"] = factory(root["React"]);
...
var Contex = function (_React$PureComponent) {
  _inherits(Contex, _React$PureComponent);

  function Contex(props) {
    _classCallCheck(this, Contex);

    var _this = _possibleConstructorReturn(this, (Contex.__proto__ || Object.getPrototypeOf(Contex)).call(this, props));
    ...
    if (props.reducer && typeof props.reducer === 'function') {
      _this.state.currentState = props.reducer(_this.state.currentState, {
        action: '@contex/INIT'
      });
    }
  ...
  _createClass(Contex, [{
    ...
    value: function dispatch(action) {
      ...
      if (reducer) {
        ...
        if (!(0, _shallowEqual2.default)(newState, currentState)) {
...
Contex.propTypes = {
  initialState: _propTypes2.default.any, // eslint-disable-line
